...
<template>
  <div>
    ...
    <p class="mt-3 font-chronicle text-parchment-400">
      Thirteen weeks, five lieutenants and a wyrm, from September to the edge of
      midwinter. Your class decides what comes easiest to you — and a company of
      six of the same thing does not get up that mountain.
    </p>
